        ...
        return(
            <nav className="pt-navbar">
                <div className="pt-navbar-group pt-align-left">
                    <div className="pt-navbar-heading">ChordPro</div>
                ...
                <div className="pt-navbar-group pt-align-right">
                    ...
                    <Link className="pt-button bt-minimal pt-icon-music" to="/songs">Songs</Link>

                    <Popover content={(<NewSongForm addSong={this.props.addSong} postSubmitHandler={this.closePopover}/>)}
